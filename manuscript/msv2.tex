...
This bifurcation occurs at lower values of the stray rate $m$ for lower trait heritability $h^2$ (Fig \ref{fig:PE}a,b), indicating that lower coupling between ecological and evolutionary dynamics in addition to greater rates of straying guarantees the existence of alternative stable states.

Trait heritability has a large impact on the sensitivity of both the total steady state density ($N^*_T=N^*_1+N^*_2$) as well as the difference between steady state densities ($\Delta N=\sqrt{(N^*_1-N^*_2)^2}$).
...
(Results here - constant m)

(Results here - density dependent m)
...
\noindent{\bf (d) The role of habitat heterogeneity on the portfolio effect}\\ 
...
\noindent{\bf (e) Linking stray rate and habitat heterogeneity}\\ 
