...
At high stray levels, there are two eco-evolutionary states: a population will either have a higher degree of local adaptation (low trait offset) and higher density or be more maladapted and have lower density. 
Whether the population goes to one state or the other in our model is random, which is due to a small amount of introduced variance in the initial conditions.
