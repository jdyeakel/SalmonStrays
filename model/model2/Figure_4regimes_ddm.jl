...
text(x=0.25,y=5.2,'Portfolio effect',xpd=T)
text(par('usr')[1]-0.088,max($(cexpvec))+0.2,'(a)', xpd=TRUE,cex=1.2)
...
text(x=0.25,y=5.2,expression(paste(log[10],' Recovery time')),xpd=T)
text(par('usr')[1]-0.088,max($(cexpvec))+0.2,'(b)', xpd=TRUE,cex=1.2)
...
text(par('usr')[1]-0.088,max($(cexpvec))+0.2,'(c)', xpd=TRUE,cex=1.2)
...
text(par('usr')[1]-0.088,max($(cexpvec))+0.2,'(d)', xpd=TRUE,cex=1.2)
dev.off()
"""
