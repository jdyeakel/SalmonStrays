...
points($mvec,$x2mean,pch=".",col=cols[2],las=1)
#dev.off()
"""
...
save(string("$(homedir())/Dropbox/PostDoc/2017_SalmonStrays/model/data_asym/data_sig_h_m.jld"),"n1mean",n1mean,"n2mean",n2mean,"x1mean",x1mean,"x2mean",x2mean,"pe",pe);


d = load(string("$(homedir())/Dropbox/PostDoc/2017_SalmonStrays/model/data_asym/data_sig_h_m.jld"));
...
namespace = string("$(homedir())/Dropbox/PostDoc/2017_SalmonStrays/manuscript/figs_asym/fig_MDPE_hm.pdf");
R"""
library(RColorBrewer)
